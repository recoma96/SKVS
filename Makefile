CC=gcc
CXX=g++ -g
CXXFLAGS= -std=c++1y -lprotobuf -pthread -DGOOGLE_PROTOBUF_NO_RTTI -I/usr/local/include
...
lib/packet/PacketSerial.pb.o: lib/packet/PacketSerial.pb.cc
	g++ -g -c -std=c++1y -o lib/packet/PacketSerial.pb.o lib/packet/PacketSerial.pb.cc -lprotobuf -pthread -DGOOGLE_PROTOBUF_NO_RTTI -I/usr/local/include
